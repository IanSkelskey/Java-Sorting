/* MergeSorter Class: Built referencing favtutor.com/blogs/sorting-algorithms-java to practice sorting algorithms.
 * 
 * Approach:
 * 			Split the array into smaller subarrays until pairs of elements are achieved, 
 * 			and then combine them in such a way that they are in order.
 * 
 * Big-O: 	
 * 			O(n log (n))
 * 
