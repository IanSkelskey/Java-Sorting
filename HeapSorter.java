/* HeapSorter Class: Built referencing favtutor.com/blogs/sorting-algorithms-java to practice sorting algorithms.
 * 
 * Approach:
 * 			Build a max (or min) heap and extract the first element of the heap (or root), and then 
 * 			send it to the end of the heap. Decrement the size of the heap and repeat 
 * 			till the heap has only one node.
 * 
 * Big-O:
 * 			O(n log (n))
 * 
